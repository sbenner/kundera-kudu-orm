...
public interface Client<Q extends Query> {
     ...
     * @param entityClass     the entity class
     * @param columnsToSelect Array of column names that need to be populated into entity
     ...
     * @param <E>               the element type
     * @param entityClass       the entity class
     * @param embeddedColumnMap Map of embedded column name and their values that are used as
     ...
     * @param pKey   Primary key of entity to be deleted
     */
     ...
     *
     * @param <E>             Type cast
     * @param schemaName      Schema/Keyspace name.
     ...
     * @param columnValue Name of column value
     */
