    ...
    private int buildResult(String[] result, int count, String property) {
        if (property != null && property.length() > 0) {
            if (property.indexOf(".") > 0) {
                result[0] = property.substring(property.indexOf("(") > 0 ? property.indexOf("(") + 1 : 0,
                        property.indexOf("."));
                String fieldName = property.substring(property.indexOf(".") + 1, property.indexOf(")") > 0 ? property.indexOf(")") : property.length());
