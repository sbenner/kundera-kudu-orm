...
public abstract class AbstractManagedType<X> extends AbstractType<X> implements ManagedType<X> {
     ...
     *
     * @param hasLobAttribute the new checks for lob attribute
     */
     ...
     *
     * @param inheritedType the inherited type
     */
     ...
     * @param descriminator      the descriminator
     * @param descriminatorValue the descriminator value
    ...
    private static class InheritanceModel {
         ...
         *
         * @param type               the type
         * @param discriminatorCol   the discriminator col
