...
import com.impetus.kundera.metadata.model.attributes.*;
import com.impetus.kundera.metadata.model.type.*;
...
public final class MetaModelBuilder<X, T> {
     ...
     * @param <X>          the generic type
     * @param clazz        the clazz
     * @param isEmbeddable the is embeddable
     */
    ...
    private class TypeBuilder<X> {
         ...
         *
         * @param attribute            the attribute
         * @param persistentAttribType the persistent attrib type
         */
        ...
        private class AttributeBuilder<X, T> {
             ...
             *
             * @param superType
             * @throws MetamodelLoaderException exception.
             */
